...
title=tk.Label(root, text="Login Here", font=("times", 25, "bold","italic"),bd=5,bg="#DDA0DD",fg="black")
title.place(x=150,y=50,width=250)
        
Login_frame=tk.Frame(root,bg="#FAE6FA")
Login_frame.place(x=50,y=150)
        
logolbl=tk.Label(Login_frame,bd=0).grid(row=0,columnspan=2,pady=20)
        
lbluser=tk.Label(Login_frame,text="Username",compound=LEFT,font=("Times new roman", 20, "bold"),bg="#FAE6FA").grid(row=1,column=0,padx=20,pady=10)
txtuser=tk.Entry(Login_frame,bd=5,textvariable=username,font=("",15))
txtuser.grid(row=1,column=1,padx=20)
        
lblpass=tk.Label(Login_frame,text="Password",compound=LEFT,font=("Times new roman", 20, "bold"),bg="#FAE6FA").grid(row=2,column=0,padx=50,pady=10)
